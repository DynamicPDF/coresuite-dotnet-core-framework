...
namespace coresuite_dotnet_standard_cs.generator
{
    public class ContactList
    {
        ...
        public static float SetExpandableRecords(Document document, SqlDataReader data, TextArea companyName, TextArea contactName, TextArea contactTitle)
        {
        ...
        public static void AddSectionHeader(SqlDataReader data)
        {
