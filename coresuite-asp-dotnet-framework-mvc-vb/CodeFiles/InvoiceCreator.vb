...
Namespace coresuite_asp_dotnet_framework_mvc_vb.CodeFiles
    ...
    Public Class InvoiceCreator
        ...
        Private Shared ReadOnly backgroundColor As WebColor = New WebColor("#E0E0FF")
        Private Shared ReadOnly totalBGColor As WebColor = New WebColor("#FFC0C0")
        Private Shared ReadOnly thankYouText As WebColor = New WebColor("#000080")
        ...
        Private Shared Function GetDetailsGroup() As Group
            ...
            Dim MyGroup As Group = New Group From {
                New Rectangle(340, 24, 200, 72, Grayscale.Black, backgroundColor, 0.5F),
        ...
        Private Sub SetPageTemplateImage()
            ...
            If Not pageTemplateImagesSet Then
                ...
                MyTemplate.Elements.Add(New Image(System.Web.HttpContext.Current.Server.MapPath("~/Images/DPDFLogo.png"), 0, 0, 0.16F))
