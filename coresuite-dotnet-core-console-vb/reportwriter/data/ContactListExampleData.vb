Public Class ContactListExampleData
    ...
    Private Shared contactGroups_1 As List(Of ContactGroup) = New List(Of ContactGroup)() From {
        New ContactGroup With {.Letter = "A", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "B", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "C", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "D", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "E", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "F", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "G", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "H", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "I", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "K", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "L", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "M", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "N", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "O", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "P", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "Q", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "R", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "S", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "T", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "V", .Contacts = New List(Of Contact)() From {
        ...
        New ContactGroup With {.Letter = "W", .Contacts = New List(Of Contact)() From {
    ...
    Public Shared ReadOnly Property ContactGroups As List(Of ContactGroup)
        Get
            Return contactGroups_1
        End Get
    End Property
End Class
