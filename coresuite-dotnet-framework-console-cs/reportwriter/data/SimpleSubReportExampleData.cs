...
/// <summary>
/// Summary description for SimpleSubReportExampleData
/// </summary>
public class SimpleSubReportExampleData
{
    ...
    private static List<Category> productsByCategory = new List<Category>()
        {
            ...
            new Category { Name = "Confections", Products = new List<Product>() {
            ...
            new Category { Name = "Dairy Products", Products = new List<Product>() {
            ...
            new Category { Name="Grains/Cereals", Products = new List<Product>() {
            ...
            new Category { Name = "Meat/Poultry", Products = new List<Product>() {
            ...
            new Category { Name = "Produce", Products = new List<Product>() {
            ...
            new Category { Name = "Seafood", Products = new List<Product>() {
    ...
    public static List<Category> ProductsByCategory
    {
