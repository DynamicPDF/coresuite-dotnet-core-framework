...
Public Class PlaceHolderExampleData
    ...
    Private Shared websites_1 As List(Of Website) = New List(Of Website)() From {
            ...
            New Website With {.Name = "Twitter", .Description = "Founded in 2006, Twitter is a popular news and social media website.", .Url = "https://www.google.com"}
    }
