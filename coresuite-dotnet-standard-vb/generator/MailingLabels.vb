...
Namespace coresuite_dotnet_standard_vb.generator
    Public Class MailingLabels
        ...
        Shared DataReader As SqlDataReader
        ...
        Public Shared Sub Run(outputPdfPath As String)
            ...
            Connection = New SqlConnection(Util.DynamicPDFConfiguration.GetConnectionString("NorthWindConnectionString"))
            Connection.Open()

            SQL = "Select CompanyName, ContactName, Phone, Fax FROM Customers"
            ...
            While DataReader.Read
                CompanyName = SafeDBNull(DataReader("CompanyName"))
                ContactName = SafeDBNull(DataReader("ContactName"))
                Phone = SafeDBNull(DataReader("Phone"))
                Fax = SafeDBNull(DataReader("Fax"))
        ...
        Shared Function SafeDBNull(ByVal Value As Object) As String
